...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccidentEntry'
        db.create_table(u'core_accidententry', (
            ...
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accidents', null=True, to=orm['core.Student'])),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accidents', null=True, to=orm['auth.User'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accident_entries', to=orm['core.Place'])),
            ('place_def', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('violation', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('violation_def', self.gf('django.db.models.fields.TextField')()),
            ('notify', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('witnesses', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('helper', self.gf('django.db.models.fields.TextField')()),
            ('first_aid', self.gf('django.db.models.fields.TextField')()),
            ('used', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'core', ['AccidentEntry'])

        # Adding model 'Place'
        db.create_table(u'core_place', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('room', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ))
        ...
        db.create_table(u'core_configuration', (
            ...
            ('pdflatex', self.gf('django.db.models.fields.CharField')(default=u'/usr/bin/pdflatex', max_length=100)),
            ('latex_options', self.gf('django.db.models.fields.CharField')(default=u'-interaction=nonstopmode', max_length=100, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'AccidentEntry'
        db.delete_table(u'core_accidententry')
