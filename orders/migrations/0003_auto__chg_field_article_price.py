...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'orders_article', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Article.price'
        raise RuntimeError("Cannot reverse this migration. 'Article.price' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Article.price'
        db.alter_column(u'orders_article', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
